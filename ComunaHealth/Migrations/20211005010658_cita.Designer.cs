            ...
            modelBuilder.Entity("ComunaHealth.Modelos.ModeloSolicitudCambioHorarioDeCita", b =>
                {
                    b.HasOne("ComunaHealth.Modelos.ModeloCita", "Cita")
                        ...
                        .HasForeignKey("ComunaHealth.Modelos.ModeloSolicitudCambioHorarioDeCita", "IdCita")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ComunaHealth.Modelos.ModeloUsuarioNoAdministrador", "Solicitante")
                        .WithMany()
