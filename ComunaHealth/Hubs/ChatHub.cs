...
namespace ComunaHealth.Hubs
{
	public class ChatHub : Hub
	{
		...
		{
			await Clients.Group(guidChat).SendAsync("RecibirMensaje", guidChat, mensaje, DateTime.UtcNow.ToString(), _userManager.GetUserName(Context.User),_userManager.GetUserId(Context.User));
		}
